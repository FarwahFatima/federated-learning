...
def train_model():
    ...
    train_dir = r'D:\DR_bisma\Datasets\Messidor_2_rehman\train'
    valid_dir = r'D:\DR_bisma\Datasets\Messidor_2_rehman\valid'
    test_dir = r'D:\DR_bisma\Datasets\Messidor_2_rehman\test'
    ...
    for name, param in model.named_parameters():
        if "features.14" not in name and "features.15" not in name and "features.16" not in name and "features.17" not in name:
    ...
    try:
        for epoch in range(num_epochs):
            ...
            if val_acc > best_val_acc:
                ...
                }, 'mobilenet_weights_Messidor.pth')
                epochs_without_improvement = 0
            else:
        ...
        checkpoint = torch.load('mobilenet_weights_Messidor.pth')
